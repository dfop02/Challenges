...
No máximo só podem haver 6 #, caso tenha mais, deve retornar a string "Wrong input".
Se houver qualquer outro caracter além de hashtag até o primeiro espaço, deve retornar a string "Wrong input".
O texto da tag, deve ser separado por um espaço após as hashtags, tudo após este espaço será considerado texto dentro da tag.
Não deve haver espaços entre o começo e o final do texto, remova-os se necessário.
